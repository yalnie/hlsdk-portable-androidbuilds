...
void CHudKeycard::Reset(void)
{

}

bool CHudKeycard::VidInit(void)
{
...
bool CHudKeycard::MsgFunc_HudKeycard(const char* pszName, int iSize, void* pbuf)
{
...
bool CHudKeycard::Draw(float flTime)
{
