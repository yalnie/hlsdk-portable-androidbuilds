...
void CHudC4::Reset(void)
{

}

bool CHudC4::VidInit(void)
{
...
bool CHudC4::MsgFunc_HudC4(const char* pszName, int iSize, void* pbuf)
{
...
int CHudC4::GetScreenPosition(int small, int medium, int large)
{
    if (ScreenWidth < 640)
        return small;
