...
void CHudRedcard::Reset(void)
{

}

bool CHudRedcard::VidInit(void)
{
...
bool CHudRedcard::MsgFunc_HudRedcard(const char* pszName, int iSize, void* pbuf)
{
...
bool CHudRedcard::Draw(float flTime)
{
