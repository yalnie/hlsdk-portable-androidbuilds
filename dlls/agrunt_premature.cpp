...
//=========================================================
void CAGruntPremature::SetYawSpeed()
{
	int ys;
...
//=========================================================
void CAGruntPremature::StopTalking()
{
...
//=========================================================
bool CAGruntPremature::ShouldSpeak()
{
...
// PrescheduleThink
//=========================================================
void CAGruntPremature::PrescheduleThink()
{
	if (ShouldSpeak())
	{
...
// DieSound
//=========================================================
void CAGruntPremature::DeathSound()
{
	StopTalking();
...
// AlertSound
//=========================================================
void CAGruntPremature::AlertSound()
{
	StopTalking();
...
// AttackSound
//=========================================================
void CAGruntPremature::AttackSound()
{
	StopTalking();
...
//=========================================================
void CAGruntPremature::Precache()
{
...
int CAGruntPremature::IgnoreConditions()
{
