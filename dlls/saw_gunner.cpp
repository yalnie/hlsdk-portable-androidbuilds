...
//=========================================================
bool CSawGunner::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
...
bool CDeadSawGunner::KeyValue(KeyValueData* pkvd)
{
